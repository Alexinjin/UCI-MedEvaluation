...
var question3_5 = require("./Question3_5");
...
class Question3_4 extends Component{
    onButtonPress(){
      if ((
        ...
        (this.excellent5 || this.verygood5 || this.good5 || this.fair5 || this.poor5 || this.none5) ) != 0)
      {
        ...
        if (this.props.numOfSpeaker == 4){
          ...
          passProps:{
            ...
            resultQ3_2: this.props.resultQ3_2,
            resultQ3_3: this.props.resultQ3_3,
            resultQ3_4: this.result,
